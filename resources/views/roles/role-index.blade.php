                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <button type="button"
                                                    ...
                                                    data-url="{{ route('roles.edit', $role->id) }}" title="Editar Rol">
                                                ...
                                                @if($role->name !== 'Administrador')
                                                    <button type="button"
                                                        ...
                                                        data-item="{{ $role->name }}" title="Eliminar Rol">
                                                        <i class="fa-solid fa-trash" style="font-size: 0.7rem;"></i>
                                                    </button>
                                                @else
                                                    <button class="btn btn-sm btn-secondary mb-0 btn-action" disabled
                                                        title="Rol Protegido">
