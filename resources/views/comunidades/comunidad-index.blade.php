        ...
        <div class="container py-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
                <div class="mb-3 mb-md-0">
                    ...
                    <p class="mb-0 text-secondary text-sm">Administra el catálogo de comunidades del sistema.</p>
                </div>
            ...
            {{-- 5. TABLA (Estilo Asignaciones: Card p-0 pb-2, Header bg-dark) --}}
                        ...
                        <table class="table table-hover align-middle text-center mb-0">
                            <thead class="bg-dark text-white">
                                <tr>
                                    ...
                                    <th class="opacity-10">Parroquia</th>
                            ...
                            <tbody>
                                @forelse ($comunidades as $c)
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="ids[]" value="{{ $c->id }}" class="check-item" style="cursor: pointer;">
                                        </td>
                                        ...
                                        <td>
                                            <span class="code-badge">{{ $c->codigo_unico ?? $c->codigo ?? 'N/A' }}</span>
                                        </td>

                                        <td class="text-start ps-4">
                                            <span class="text-sm font-weight-bold text-dark">{{ $c->nombre }}</span>
                                        </td>

                                        <td>
                                            <span class="badge border" style="background-color: #f8f9fa; color: #343a40;">
                                                {{ $c->parroquia->nombre ?? 'N/A' }}
                                            </span>
                                        </td>
                                        
                                        <td>
                                            <span class="badge border" style="background-color: #fff; color: #6c757d;">
                                                {{ $c->parroquia->canton->nombre ?? 'N/A' }}
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger mb-0 btn-action js-delete-btn"
                                                    ...
                                                    data-item="{{ $c->nombre }}" title="Eliminar">
